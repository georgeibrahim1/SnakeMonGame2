...
public:
	...
	Snake* GetNextSnake(const CellPosition& position); //(Team) Gets a Pointer to the first Snake after the passed "position"
	...
	void setwasexecuted(int, bool);
	bool getwasexecuted(int);
